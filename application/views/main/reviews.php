		...
		<ul>
			<li>
				<div class="reviews_item">
					<div class="reviews_item_pic"><img src="/include/images/rev1.png"></div>
			...
			<li>
				<div class="reviews_item">
					<div class="reviews_item_pic"><img src="/include/images/rev2.png"></div>
			...
			<li>
				<div class="reviews_item">
					<div class="reviews_item_pic"><img src="/include/images/rev3.png"></div>
